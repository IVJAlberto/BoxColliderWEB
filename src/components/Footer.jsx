...
export const Footer = () => {
  return (
    <div className="h-[60vh] md:h-[50vh] bg-[#414141] grid grid-cols-1 grid-rows-11 md:grid-rows-7">
        ...
        <section className="row-span-6 md:row-span-2 grid grid-rows-6 grid-cols-1 md:grid-rows-1 md:grid-cols-6 justify-center md:px-[10vw]">
            ...
            <div className="row-span-2 md:col-span-2 md:row-span-1 grid grid-rows-2 md:grid-rows-3 flex-wrap content-center justify-center pt-2 md:pt-0">
                <h1 className="flex-wrap content-center md:content-start text-white text-xl text-center font-montserratregular">Síguenos</h1>
            ...
            <div className="row-span-2 md:col-span-2 md:row-span-1 grid grid-rows-2 md:grid-rows-3 flex-wrap content-center justify-center pt-2 md:pt-0">
                <h1 className="flex-wrap content-center md:content-start text-white text-xl font-montserratregular">Contáctanos</h1>
        ...
        <section className="row-span-2 flex-wrap content-center flex justify-center px-[30vw]">
            <h1 className="text-white text-center text-sm font-montserratregular"> Hecho con ❤️ por BoxCollider 2024</h1>
        </section>
